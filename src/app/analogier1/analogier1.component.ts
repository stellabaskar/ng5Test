...
@Component({
  selector: 'app-analogier1',
  templateUrl: './analogier1.component.html',
  styleUrls: ['./analogier1.component.css']
})
export class Analogier1Component implements AfterViewInit {
