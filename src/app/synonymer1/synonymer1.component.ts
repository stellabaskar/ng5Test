...
@Component({
  selector: 'app-synonymer1',
  templateUrl: './synonymer1.component.html',
  styleUrls: ['./synonymer1.component.css']
})
export class Synonymer1Component implements AfterViewInit {
