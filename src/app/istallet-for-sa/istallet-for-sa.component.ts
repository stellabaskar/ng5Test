...
@Component({
  selector: 'app-istallet-for-sa',
  templateUrl: './istallet-for-sa.component.html',
  styleUrls: ['./istallet-for-sa.component.css']
})
export class IstalletForSaComponent implements AfterViewInit {
