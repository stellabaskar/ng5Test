...
@Component({
  selector: 'app-snostormen',
  templateUrl: './snostormen.component.html',
  styleUrls: ['./snostormen.component.css']
})
export class SnostormenComponent implements AfterViewInit {
