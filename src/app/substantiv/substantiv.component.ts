...
@Component({
  selector: 'app-substantiv',
  templateUrl: './substantiv.component.html',
  styleUrls: ['./substantiv.component.css']
})
export class SubstantivComponent implements AfterViewInit {
