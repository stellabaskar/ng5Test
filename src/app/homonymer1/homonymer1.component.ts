...
@Component({
  selector: 'app-homonymer1',
  templateUrl: './homonymer1.component.html',
  styleUrls: ['./homonymer1.component.css']
})
export class Homonymer1Component implements AfterViewInit {
