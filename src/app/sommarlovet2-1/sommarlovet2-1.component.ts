...
@Component({
  selector: 'app-sommarlovet2-1',
  templateUrl: './sommarlovet2-1.component.html',
  styleUrls: ['./sommarlovet2-1.component.css']
})
export class Sommarlovet21Component implements AfterViewInit {
