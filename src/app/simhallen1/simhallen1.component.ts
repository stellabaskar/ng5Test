...
@Component({
  selector: 'app-simhallen1',
  templateUrl: './simhallen1.component.html',
  styleUrls: ['./simhallen1.component.css']
})
export class Simhallen1Component implements AfterViewInit {
